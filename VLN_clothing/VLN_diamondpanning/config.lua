Config = {} 
Config.locale = 'RA_lang' -- Change the language in the locales folder
...
Config.waterBucket = "watering_can_diamond" --!!!IF YOU USE A RIVER OR WATER SCRIPT AND MATCH THE ITEM NAMES!!!
Config.emptyWaterBucket = "watering_can_empty" --!!!IF YOU TO USE A RIVER OR WATER SCRIPT AND MATCH THE ITEM NAMES!!!
...
Config.goldPan = "diamondpan" --Item name needed
Config.washBuildTime = 8000 --Time to build the wash station
Config.goldWashTime = 8000 -- Time To Pan
Config.goldWashReward = "diamond_flakes" --Item to give
Config.goldWashRewardAmount = 5 --Amount of reward to give
-----------------------------------

--Extra Reward, because why not--
Config.extraReward = "diamond_nugget" --Item to give
Config.extraRewardAmount = 3 --Amount of reward to give
Config.extraRewardChance = 2 -- Chance of getting the extra reward
