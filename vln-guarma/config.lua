...
Config.shops = {
    stdenis = {
        shop = {
            ...
            prompt      = 'To Guarma', -- Text Below the Menu Prompt Button
        ...
        npc = {
            ...
            coords   = vector3(821.29, -1912.33, 42.5), -- NPC and Shop Blip Positions
            heading  = 246.19,                            -- NPC Heading
            distance = 100                                -- Distance Between Player and Shop for NPC to Spawn
        },
        player = {
            coords  = vector3(833.52, -1918.79, 42.85), -- Player Teleport Position
        ...
        price = {
            currency = 2,        -- 1 = cash, 2 = gold, 3 = item
            amount = 10000,          -- Amount of Cash, Gold or Items
            item = {
    ...
    guarma = {
        shop = {
            name        = 'Guarma Port',           -- Used while Traveling and in Closed Shop Message
            prompt      = 'Guarma to Valentine', -- Text Below the Menu Prompt Button
            distance    = 2.0,                     -- Distance Between Player and Shop to Show Menu Prompt
            jobsEnabled = false,                   -- Allow Shop Access to Specified Jobs Only
            jobs        = {                        -- Insert Job to Limit Access - ex. jobs = {{name = 'police', grade = 1},{name = 'doctor', grade = 3}}
                { name = 'police', grade = 1 },
